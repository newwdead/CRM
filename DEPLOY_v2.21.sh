...
# =============================================================================
# FastAPI BizCard CRM - Deployment Script v2.21.0
# Critical Bug Fixes
# =============================================================================

set -e  # Exit on any error

echo "🚀 Starting deployment of FastAPI BizCard CRM v2.21.0..."
echo "🐛 Release: Critical Bug Fixes"
echo ""
...
BACKEND_VERSION=$(curl -s http://localhost:8000/version | python3 -m json.tool 2>/dev/null | grep version || echo "unknown")
echo -e "${BLUE}Version: $BACKEND_VERSION${NC}"
...
echo -e "${GREEN}═══════════════════════════════════════════════════════════${NC}"
echo ""
echo -e "${BLUE}📦 Version:${NC} 2.21.0"
echo -e "${BLUE}🏷️  Release:${NC} Critical Bug Fixes"
...
echo -e "   1. 🔧 Service Management - Fixed empty page"
echo -e "   2. 📝 OCR Editor - Confirmed features working"
echo -e "   3. 🖼️  Multi-Card Processing - Fixed detection & user assignment"
echo ""
echo -e "${BLUE}📝 Release Notes:${NC} RELEASE_NOTES_v2.21.md"
echo ""
